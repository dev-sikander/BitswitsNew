...
export const BannerData = {
    ...
    title: "Capture, Share, and Connect!",
}
...
export const FeaturesData = {
    ...
    subtitle: "Features",
    title: "Key Highlights of Soul Scribe",
    content: "Soul Scribe combines the essence of journaling with the power of social interaction. It allows users to document memories, connect with friends and family, and create collaborative experiences. Its features ensure seamless management of your digital diary while fostering meaningful interactions through shared memories.",
}
...
export const ProblemBullets = [
    "No journaling-social platforms",
    "Complex post management",
    "Privacy concerns with sharing",
    "Lack of user collaboration",
    "Simplifying interactions effortlessly",
]
...
export const SolutionBullets = [
    "Developed seamless memory and post management features.",
    "Enabled private, shared journaling with family and friends.",
    "Integrated intuitive privacy controls for enhanced user comfort.",
...
export const TechStackData = {
    ...
    content: "We leveraged advanced technologies and frameworks to build a secure, scalable, and user-friendly platform for seamless interaction.",
}
...
export const ResultBullets = [
    (<>75%<span>Increase in Engagement</span></>),
    (<>60%<span>Growth in Subscriptions</span></>),
    (<>40,000+<span>Memories Shared</span></>),
]
