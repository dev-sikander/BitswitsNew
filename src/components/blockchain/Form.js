...
const Form = (props) => {
    ...
    return (
        <>
            <form className={style[props.formshome]} onSubmit={handleSubmit}>
                <input className={style.formControl} type="text" name='name' placeholder="Name" required />
                <input className={style.formControl} type="tel" name='phone' placeholder="Phone Number" required />
                <input className={style.formControl} type="email" name='email' placeholder="Email" required />
                <textarea type="textarea" name='comment' className={style.formControl} placeholder="Message"  ></textarea>
